...
Current release candidate: `v1.0.0-rc.16`
...
| Получить release candidate SHA | PASS | Tag `v1.0.0-rc.16` must point at the same HEAD verified by `scripts/production-v1-local-audit.ps1` | Create final tag after merge |
