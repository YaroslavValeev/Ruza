...
- Release gates: clean-tree guard, production env guard, staging/prod proof gate, server healthcheck guard, restore-backup guard, mobile-readiness guard, rollback guard, PR #4, tag `v1.0.0-rc.18`, локальный production audit.
