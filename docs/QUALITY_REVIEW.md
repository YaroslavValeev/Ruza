...
- Release gates: clean-tree guard, production env guard, staging/prod proof gate, server healthcheck guard, restore-backup guard, rollback guard, PR #4, tag `v1.0.0-rc.17`, локальный production audit.
